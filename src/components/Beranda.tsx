...
export function Beranda({ onVenueClick, onNavigate }: BerandaProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-[#FFE4E9]/20">
      {/* Hero Banner */}
      <section className="relative min-h-[80dvh] pb-10 mt-[-3em] sm:mt-0 sm:h-[500px] bg-gradient-to-r from-[#D4AF37]/10 via-[#FFB6C1]/10 to-[#F4E4C1]/10 overflow-hidden">
        ...
        <div className="relative mt-28 sm:mt-0 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center items-center text-center">
          ...
          <h1 className="text-4xl font-dancingScript md:text-5xl lg:text-6xl mb-6 max-w-4xl bg-gradient-to-r from-[#D4AF37] to-[#FFB6C1] bg-clip-text text-transparent">
          ...
          {/* Search Bar */}
          <Card className="w-full max-w-4xl shadow-xl border-[#F4E4C1]">
              ...
              <div className="grid md:grid-cols-4 gap-4">
                ...
                <div className="md:col-span-1">
                  <Button 
                    ...
                    className="w-full h-full bg-gradient-to-r from-[#D4AF37] to-[#FFB6C1] hover:brightness-90 text-white"
                  >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          <Card className="border-[#F4E4C1] hover:shadow-xl transition-shadow">
            <CardContent className="p-6 text-center">
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-[#D4AF37]/20 to-[#FFB6C1]/20 flex items-center justify-center">
      ...
      {/* Promo Banner */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-gradient-to-r from-[#D4AF37] to-[#FFB6C1] rounded-2xl p-8 text-white text-center">
          ...
          <Button variant="secondary" className="bg-white text-[#D4AF37] hover:bg-gray-100">
            Lihat Promo
          </Button>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="overflow-hidden border-[#F4E4C1] hover:shadow-xl transition-shadow">
            <div className="relative h-48">
              <ImageWithFallback
                ...
                className="w-full h-full object-cover"
              />
              <div className="absolute top-3 left-3 bg-[#D4AF37] text-white px-3 py-1 rounded-full text-xs">
                Sponsored
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {venues.map((venue) => (
            <Card 
              ...
              className="overflow-hidden hover:shadow-xl transition-shadow border-[#F4E4C1] cursor-pointer"
            >
              <div className="relative h-48">
                <ImageWithFallback
                  src={venue.image}
              ...
              <CardContent className="p-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-[#D4AF37] font-bold text-xl">{venue.price}</span>
      ...
      <section className="bg-gradient-to-r from-[#F4E4C1]/30 to-[#FFE4E9]/30 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-center mb-12">Apa Kata Mereka?</h2>
          <div className="relative">
            <Card className="border-[#F4E4C1] shadow-xl">
              <CardContent className="p-8">
                <div className="flex flex-col md:flex-row gap-6 items-center">
                  ...
                  <div className="flex-1 text-center md:text-left">
                    ...
                    <p className="text-[#D4AF37]">{testimonials[currentTestimonial].name}</p>
            ...
            <div className="flex justify-center gap-4 mt-6">
              <Button
                ...
                className="rounded-full border-[#D4AF37] text-[#D4AF37] hover:bg-[#F4E4C1]/30"
              >
